...
The goal of this project is to reduce the computational cost of video action recognition on mobile devices by compressing a heavy 3D ResNet-50 teacher model into an ultra-lightweight 3D MobileNet student via Knowledge Distillation (KD) on the HMDB-51 dataset. 
